...
function votacao(req, res) {
    ...
    var usuario = req.body.usuarioServer;
        ...
        usuarioModel.votacao(modalidade, skatista, usuario)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
